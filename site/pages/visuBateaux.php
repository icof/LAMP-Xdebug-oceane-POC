...
if ((isset($_POST['niveauPMR'])) && ($_POST['niveauPMR'] != "")) {
	...
	$SQL = "SELECT * FROM bateau b JOIN niveau_accessibilite n ON b.niveauPMR=n.idNiveau WHERE b.niveauPMR = :niveau ORDER BY b.nom";
	$stmt = $connexion->prepare($SQL);
	$stmt->bindParam(':niveau', $niveauPMR, PDO::PARAM_INT);
	$stmt->execute();
