...
--
-- Host: localhost    Database: oceane_db
-- ------------------------------------------------------
...
VALUES (
    ...
    (
        ...
        'Melvan',
        'melvan.jpg',
        'Mis en service en février 2010, le MELVAN porte le nom d’un îlot rocheux situé entre les deux îles qu’il dessert, Houat et Hoëdic. \r\n\r\nAvec une vitesse moyenne de 16,5 nœuds, il permet de rallier, au départ de Quiberon, Houat en 40 minutes et Hoëdic en 55 minutes. \r\n\r\nCette vedette, adaptée aux besoins de ces îles, permet de transporter jusqu’à 234 passagers et 45 tonnes de fret. ',
        31,
        8.06,
        16.5,
        2
    ...
    (
        ...
        'Breizh Nevez I',
        'breizh-nevez-I.jpg',
        'Le BREIZH NEVEZ I est le dernier roulier (ou transbordeur ou ferry) de la flotte  de la Compagnie Océane mis en exploitation sur les liaisons vers les îles de Bretagne sud. Il a effectué ses premières traversées commerciales en avril 2018.\r\n\r\nIl déplace ses 43.5 mètres de long et 11.6 mètres de large à une vitesse de 11.5 nœuds. Sa capacité maximum est de 300 passagers et de 18 véhicules de tourisme. Il effectue la traversée entre Lorient et l‘Ile de Groix en 45 minutes. ',
        43.5,
        11.6,
        11.5,
        2
...
VALUES (
        1,
        'non adapté PMR',
        'Navire qui ne contient pas d\'équipement pour les personnes à mobilité réduite.'
    ),
    (
        2,
        'adapté PMR',
        'Navire aménagé pour accueillir les personnes à mobilité réduite.'
    ),
    (
        3,
        'adapté PMR + ascenseur',
        'Navire équipé d’un ascenseur aux normes PMR permettant aux personnes à mobilité réduite d’accéder aux salons voyageurs.'
    );
...
VALUES (
        'HF',
        'Haute fréquentation',
        'Les vendredis, samedis, dimanches et jours fériés du 01/04 au 30/09'
    ),
    (
        'PN',
        'Période normale',
        'Du 01/10 au 31/03 et du lundi au jeudi du 01/04 au 30/09, hors jours fériés'
    );
...
VALUES (
        'Le Palais',
        'gare maritime de Le Palais',
        'La gare maritime de Le Palais est ouverte toute l’année de 08h30 à 12h15 et de 14h00 à 18h00.',
        'Quai Bonnelle 56360 Le Palais',
        'le-palais.jpg',
        'https://pv.viewsurf.com/id/848/a/media/c/4416?i=Njk0ODp1bmRlZmluZWQ'
    ),
    (
        'Lorient',
        'gare maritime de Lorient',
        'La gare maritime de Lorient est ouverte toute l’année du lundi au dimanche 30 minutes avant le premier départ et jusqu’au dernier départ de la journée. <br>\r\nLe dimanche et les jours fériés, les guichets ferment après le dernier départ du matin et rouvrent 30 minutes avant le départ de l’après-midi.\r\n<br>Pour faciliter votre stationnement à proximité de la gare maritime, anticipez votre arrivée à Lorient et utilisez les parkings à proximité.',
    ...
    (
        'Port Argol',
        'gare maritime de port Argol de Hoëdic',
        'La gare maritime du port de Hoëdic est ouverte toute l’année 30 minutes avant chaque départ.',
        'Port de Hoëdic 56170 île de Hoëdic',
        'port-argol.jpg',
        ''
    ),
    (
        ...
        'La gare maritime de Port de Saint-Gildas est ouverte toute l’année 30 minutes avant chaque départ.',
        'Port de Saint-Gildas 56170 île d\'Houat',
        'port-st-gildas.jpg',
        ''
    ),
    (
        ...
        'La gare maritime de Port Tudy est ouverte toute l’année 30 minutes avant chaque départ.<br> Port Tudy dispose d’une salle d’attente moderne disposant de places assises et d’une zone d’embarquement couverte permettant de vous protéger des intempéries ou de fortes chaleurs.',
        'Port Tudy 56590 île de Groix',
        'port-tudy.jpg',
        'http://www.groix.fr/?mode=webcam'
    ),
    (
        'Quiberon',
        'gare maritime de Quiberon',
        'La gare maritime de Quiberon est ouverte toute l’année du lundi au dimanche 30 minutes avant le premier départ et jusqu’au dernier départ de la journée. <br>\r\nPour faciliter les flux de véhicules et de passagers, nous vous invitons à respecter les horaires d’embarquement, mais aussi à utiliser les parkings relais et les navettes dès leur mise en service.',
...
VALUES ('PA', 1, 'Adulte'),
    ...
    (
        'PA',
        4,
        'PMR 50% du plein tarif à partir taux d’invalidité de 50%'
    ),
    (
        'VE',
        4,
    ...
    (
        'PA',
        5,
        'PMR accompagnateur 50% du plein tarif si taux d’invalidé de 80%'
    ),
    (
        'VE',
        5,
    ...
    (
        'VE',
        6,
        'Véhicule C1 (Longueur inférieure à 4,00 m)'
    ),
    (
        'VE',
        7,
        'Véhicule C2 (Longueur de 4,00 m à 4,39 m )'
    ),
    (
        'VE',
        8,
        'Véhicule C3 (Longueur de 4,40 m à 4,79 m )'
    ),
    (
        'VE',
        9,
        'Véhicule C4 (Longueur de supérieure à 4,80 m)'
    ),
    (
        'VE',
        10,
        'Véhicule C5 (Camping-car, véhicule hauteur de + de 2,10 m , remorque de longueur de + de 5,00 m)'
    ),
    (
        'VE',
        11,
        'Chargement extérieur 1 (Hauteur de véhicule + galerie chargée inférieure ou égale à 2,10 m)'
    ),
    (
        'VE',
        12,
        'Chargement extérieur 2 (Hauteur de véhicule + galerie chargée supérieurs à 2,10 m) ou porte-vélos'
    );
...
-- Dump completed on 2026-01-09 16:45:35